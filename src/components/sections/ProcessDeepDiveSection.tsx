      ...
      <div className="section-container">
        ...
        >
          <div className="kpi-card">
            ...
            <p className="text-muted-foreground text-xs mb-1">Worst Op Code NOK%</p>
            <p className="text-xl font-bold">
              <span className="text-accent">2-5SP</span> → 50.0%
            </p>
          </div>
          <div className="kpi-card">
            <TrendingUp className="w-6 h-6 text-secondary mx-auto mb-2" />
            <p className="text-muted-foreground text-xs mb-1">Highest range torque</p>
            <p className="text-xl font-bold">
              <span className="text-secondary">1-URYU</span> → 596.3
            </p>
          </div>
          <div className="kpi-card">
            <Activity className="w-6 h-6 text-secondary mx-auto mb-2" />
            <p className="text-muted-foreground text-xs mb-1">Highest Variability</p>
            <p className="text-xl font-bold">
              <span className="text-secondary">2-5SP</span> → 219.8
            </p>
          </div>
          <div className="kpi-card">
            <XCircle className="w-6 h-6 text-accent mx-auto mb-2" />
            <p className="text-muted-foreground text-xs mb-1">Highest % failed</p>
            <p className="text-xl font-bold">
              <span className="text-accent">1-URYU</span> → 15.0
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8 mb-12">
          <div className={`chart-container p-4 ${isInView ? "animate-slide-in-left delay-200" : "opacity-0"}`}>
            <h3 className="font-semibold mb-4 text-lg">Heatmap Operation x Screw (%NOK)</h3>
            <QlikEmbed
          ...
          <div className={`chart-container p-4 ${isInView ? "animate-slide-in-right delay-300" : "opacity-0"}`}>
            <h3 className="font-semibold mb-4 text-lg">Torque vs Angle Per Op Code</h3>
            <QlikEmbed
        ...
        {/* Footer */}
        <div className={`mt-20 text-center ${isInView ? "animate-fade-up delay-500" : "opacity-0"}`}>
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-secondary/10 rounded-full">
            ...
            <span className="font-semibold text-foreground">DAF Trucks N.V.</span>
            <span className="text-muted-foreground">|</span>
            <span className="text-muted-foreground text-sm">Westerlo Axle Factory Dashboard</span>
          </div>
        </div>
      </div>
    </section>
